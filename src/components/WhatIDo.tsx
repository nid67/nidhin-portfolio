        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Algorithms & Optimization</h4>
              <p>
                Solving complex algorithmic challenges and optimizing data structures to build highly efficient and scalable computational solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>BACKEND</h3>
              <h4>Scalable Server Logic</h4>
              <p>
                Developing robust server-side logic and managing databases to power
                scalable applications and complex data systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                NLP, and computer vision to solve real-world problems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
